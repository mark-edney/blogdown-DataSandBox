...
keywords as I see fit. The file can be download [here](https://github.com/mark-edney/Resumes/blob/master/Word_Cloud/Keywords.csv) from my github site. Here
...
of keywords would use only the first word and lose the context. 

This challenge was met by breaking the website down into ngrams. An over simplification 
of an ngram is a group of n number of words. Wikipedia has a very good page that
better explains ngrams.[^3] The website can then be split into ngrams of different
lengths and the keywords searched for. 

As an example, the phrase:

> The quick brown fox

for an ngram of length 1 would return:

> (The) (quick) (brown) (fox)

for an ngram of length 2 would return:

> (The quick) (quick brown) (brown fox)

and for an ngram of length 3 would return:
