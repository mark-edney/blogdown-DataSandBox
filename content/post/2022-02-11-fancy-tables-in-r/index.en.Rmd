...
![GT table structure](images/gt_parts_of_a_table.svg)
...
A useful resource for learning the GT library is a article on R studio found [here](https://gt.rstudio.com/articles/intro-creating-gt-tables.html). It goes through more in depth on the topics that I have skimmed over. 