...
The following code is used for the server side logic, this includes downloading the data from the 'opentoronto' library.
...
The final application takes a while to load as the data needs to be downloaded and sorted through. In future iterations I would save the data locally as a RDS file. 
