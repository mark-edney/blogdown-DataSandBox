...
archives:
  - 2022/03
--- 
I recently wrote a post about [creating dashboards in R](https://datasandbox.netlify.app/post/2022-03-10-creating-dashboard-in-r/) which was based on the fleboard library. My largest critisim was the lack of communication between visualizations on the same dashboard. This was before I learnt about the `Crosstalk` package which adds this feature to html widgets, such as the flexdashboard, to atleast a limitied degree.
...
The key to the `crosstalk` library is the `SharedData` functions. An object is create when a Data Frame is passed to the `SharedData$new` function. This is what enables communication between plots.
...
The dashboard is create pretty much as previous mentioned in [my dashboard post](https://datasandbox.netlify.app/post/2022-03-10-creating-dashboard-in-r/) with the exception that the shared Data Frame object is passed rather than the Data Frame. 
